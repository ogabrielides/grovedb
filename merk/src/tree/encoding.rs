...
mod tests {
    ...
    #[test]
    fn encode_decode_leaf_tree() {
        let tree = Tree::from_fields(vec![0], vec![1], [55; 32], None, None, BasicMerk).unwrap();
        Tree::decode(vec![0], tree.encode().as_slice());
    }
    ...
    fn encode_loaded_tree() {
        ...
        assert_eq!(
            tree.encode(),
            vec![
                0, 1, 1, 2, 66, 66, 66, 66, 66, 66, 66, 66, 66, 66, 66, 66, 66, 66, 66, 66, 66, 66,
    ...
    fn decode_reference_tree() {
        let bytes = vec![
            0, 1, 1, 2, 66, 66, 66, 66, 66, 66, 66, 66, 66, 66, 66, 66, 66, 66, 66, 66, 66, 66, 66,
